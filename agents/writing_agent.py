...
def generate_unique_task1_prompts(count: int = 3) -> list[dict]:
    # Static rich visuals (served by frontend /public/images) + IELTS-style prompt text.
    prompt_bank = [
        {
            "text": "The bar chart compares renewable energy adoption among five countries in 2010 and 2020. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/chart_bar_energy.svg",
        },
        {
            "text": "The line graph illustrates average monthly rainfall levels in three cities over one year. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/chart_line_rainfall.svg",
        },
        {
            "text": "The pie charts show how a university allocated its annual budget in 2005 and 2025. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/chart_pie_budget.svg",
        },
        {
            "text": "The table presents international student enrollment across four faculties between 2018 and 2023. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/chart_table_students.svg",
        },
        {
            "text": "The maps compare a town center in 2000 with its current layout. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/map_town_center.svg",
        },
        {
            "text": "The bar chart compares weekly public library visitors by age group in 2012 and 2022. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/chart_bar_library_visitors.svg",
        },
        {
            "text": "The line chart shows trends in average house prices in three cities from 2008 to 2023. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/chart_line_house_prices.svg",
        },
        {
            "text": "The table provides data on graduate employment rates within six months across five subject areas from 2021 to 2024. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/chart_table_graduate_employment.svg",
        },
        {
            "text": "The maps illustrate the current airport terminal and a proposed redevelopment plan including gate expansion and retail zones. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/map_airport_redevelopment.svg",
        },
        {
            "text": "The maps show the existing university campus road network and a future expansion plan. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1/map_campus_expansion.svg",
        },
        {
            "text": "The map below shows a planned redevelopment of a coastal village between 1995 and 2025. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
            "image_url": "/images/task1_map.png",
        },
        {
            "text": "The charts compare the proportion of men and women in further education in Britain across three academic years. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.",
